...
//     <div
//       onClick={() => {
//         navigate(`/property/land/${property?._id}`);
//       }}
...
export default function LandCard({ property, userRole }) {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const [openLeads, setOpenLeads] = useState(false);
  ...
  return (
    <div
      onClick={() => navigate(`/property/land/${property?._id}`)}
    ...
    >
      ...
      <div className="flex flex-row">
        ...
        <div className="flex-1 min-w-0 p-2.5 flex flex-col justify-between">
          ...
          {/* Features: width / length / plot area */}
          <div className="flex items-center gap-2 text-[9px] text-slate-600 mb-1.5">
            <span className="flex items-center gap-0.5">
              <LucidePanelLeftDashed className="w-2.5 h-2.5 text-slate-400" />
            ...
            <span className="flex items-center gap-0.5">
              <LucidePanelRightDashed className="w-2.5 h-2.5 text-slate-400" />
              <span className="font-semibold">
                {property?.dimensions?.length || 0}
              </span>
            ...
            <span className="flex items-center gap-0.5">
              ...
              <span className="font-semibold">{property?.plotArea || 0}</span>
              <span className="text-[8px]"> sqft/plot area</span>
            </span>
          </div>
