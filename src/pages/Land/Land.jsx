//frontend\admin-dashboard\src\pages\Land\Land.jsx
...
export default function Land() {
  ...
  const {
    ...
    queryKey: ["land"],
    queryFn: ({ pageParam = 1 }) =>
      fetchLand({ page: pageParam, limit: 20 }),
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
          <div className="bg-white w-full max-w-sm md:max-w-md p-4 md:p-6 rounded-xl shadow-xl animate-fade-in">
            ...
            <p className="text-sm md:text-base text-slate-700 mt-3 md:mt-2 leading-relaxed">
              Are you sure you want to delete this land property? This action
              cannot be undone.
            </p>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-1 max-sm:text-center">
            Explore land property listings.
          </p>
        </div>
