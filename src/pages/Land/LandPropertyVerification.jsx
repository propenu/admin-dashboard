// frontend/admin-dashboard/src/pages/Land/LandPropertyVerification.jsx
...
const PropertyVerification = () => {
  ...
  const mutation = useMutation({
    mutationFn: (payload) => updateLandDocumentStatus(id, payload),
    onSuccess: () => {
      queryClient.invalidateQueries(["land", id]);
  ...
  if (isLoading)
    ...
    const REJECTION_REASONS =  [
        ...
        "Plot details do not match the uploaded document",
        "Uploaded document appears altered or tampered with",
        "Plot images are unclear or of poor quality",
