// // frontend/admin-dashboard/src/pages/users/AllUserInDetails/EachUserCompoents/CustomerCare.jsx
...
// const CustomerCareCard = ({ user, index }) => {
...
//     try {
//       const response = await getUserSearch("customer_care");
//       setAccounts(response?.data?.results || []);
//     } catch (err) {
//       console.error("Failed to fetch customer care:", err);
//       setAccounts([]);
//     } finally {
//       setLoading(false);
//     }
...
//           Manage and view all active customer care users
//         </p>
...
//               <CustomerCareCard key={user._id} user={user} index={idx} />
//             ))}
//           </div>
//         )}
//       </div>
...
const CustomerCare = () => {
  return <RoleUsers role="customer_care" />;
};
