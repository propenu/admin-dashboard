// // frontend/admin-dashboard/src/pages/users/AllUserInDetails/EachUserCompoents/Accounts.jsx
...
//     try {
//       const response = await getUserSearch("accounts");
...
//           Manage and view all active accounts users
//         </p>
...
//               <AccountCard key={user._id} user={user} index={idx} />
//             ))}
//           </div>
//         )}
//       </div>
...
const Accounts = () => {
  return <RoleUsers role="accounts" />;
};
