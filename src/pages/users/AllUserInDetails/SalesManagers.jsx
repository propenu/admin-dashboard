// // frontend/admin-dashboard/src/pages/users/AllUserInDetails/EachUserCompoents/SalesManagers.jsx
// import React, { useEffect, useState } from "react";
// import { getUserSearch } from "../../../features/user/userService";
// import { Phone, Mail, Shield,  UsersIcon } from "lucide-react";
// Phone
...
//   const permissions = manager.role?.permissions || [];
...
//     try {
//       const response = await getUserSearch("sales_manager");
...
//                 {managers.length.toString().padStart(2, "0")}
//               </span>
...
//           Manage and view all active sales managers
//         </p>
...
//               <ManagerCard key={manager._id} manager={manager} index={idx} />
//             ))}
//           </div>
//         )}
//       </div>
...
const SalesManagers = () => {
  return <RoleUsers role="sales_manager" />
};
