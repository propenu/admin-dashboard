    ...
    <div className="space-y-6">
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white w-full max-w-sm p-6 rounded-xl shadow-xl">
            ...
            <p className="text-slate-700 mt-2">
              Are you sure you want to delete this Prime Projects? This action
              cannot be undone.
            </p>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="p-6 flex flex-col text-center">
          ...
          <p className="text-slate-500 text-sm">Total Prime Projects</p>
        </div>
      </div>
      ...
      <div className="mt-6">
        ...
        <div className="flex items-center justify-between  mb-4">
          <h2 className="text-xl font-bold text-[#27AE60]  max-sm:text-sm ">
            Prime Projects
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {visibleProperties.map((p) => (
              <div key={p._id} className="relative group">
                <PropertyCard property={p} onRankUpdated={handleRankUpdated} />
                <button
                  onClick={() => {
                    setDeleteId(p._id);
