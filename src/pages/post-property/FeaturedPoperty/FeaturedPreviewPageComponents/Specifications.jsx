...
//         <div className="max-w-5xl mx-auto flex items-center gap-1 px-6 py-3 overflow-x-auto">
//           <TabButton
//             label="All"
...
// function TabButton({ label, active, color, onClick, count }) {
//   return (
//     <button
//       onClick={onClick}
//       className={`flex-none flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap transition-all duration-200 ${
//         active
...
//       {count !== undefined && (
//         <span
//           className={`text-[10px] px-1.5 py-0.5 rounded-full font-bold ${active ? "bg-white/25 text-white" : "bg-gray-100 text-gray-400"}`}
//         >
//           {count}
//         </span>
//       )}
...
//         <h3 className="text-base font-bold text-gray-800">{group.category}</h3>
//         <div className="flex-1 h-px bg-gray-200" />
//         <span className="text-xs text-gray-400 font-medium">
//           {group.items?.length ?? 0} specs
//         </span>
//       </div>
...
//   return (
//     <div className="group relative bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 overflow-hidden">
//       <div
//         className="absolute top-0 left-0 right-0 h-0.5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
//         style={{ background: `linear-gradient(90deg, ${color}, transparent)` }}
//       />
//       <span
//         className="absolute top-3 right-4 text-4xl font-black opacity-[0.04] select-none leading-none"
//         style={{ color }}
//       >
//         {String(index + 1).padStart(2, "0")}
//       </span>
//       <h4 className="text-sm font-bold text-gray-800 mb-2 leading-snug pr-6">
//         {item.title}
//       </h4>
//       {item.description && (
