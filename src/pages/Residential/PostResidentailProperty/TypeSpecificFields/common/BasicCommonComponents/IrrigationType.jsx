...
const IRRIGATION_TYPES = ["Rainfed", "Canal", "Borewell", "Drip", "Sprinkler", "River", "Tank"];
...
const IrrigationType = ({ error }) => {
  ...
  const selected = form.irrigationType || "";

  return (
    <div className="space-y-2">
      <p className="text-xs font-bold text-[#374151] uppercase tracking-wide">Irrigation Type</p>
      <div className="relative" ref={dropdownRef}>
        <div
          onClick={() => setOpen(!open)}
        ...
        >
          {selected || "Select irrigation type"}
            ...
            <div className="max-h-48 overflow-y-auto">
              {IRRIGATION_TYPES.map((type) => {
                ...
                return (
                  <div
                    key={type}
                    onClick={() => { updateFieldValue("irrigationType", type); setOpen(false); }}
