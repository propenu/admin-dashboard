...
//             errors.parkingType ? "border-red-300" : open ? "border-[#27AE60] ring-2 ring-[#27AE60]/10" : "border-[#e5e7eb] hover:border-[#bbf7d0]"
...
//         </div>
//         {errors.parkingType && <p className="text-red-500 text-xs font-medium mt-1">{errors.parkingType}</p>}
...
//                   <div
//                     key={opt.value}
//                     onClick={() => { updateFieldValue("parkingType", opt.value); setOpen(false); }}
...
//           value={form.twoWheeler || 0}
//           onDecrement={() => updateFieldValue("twoWheeler", Math.max(0, Number(form.twoWheeler || 0) - 1))}
//           onIncrement={() => updateFieldValue("twoWheeler", Number(form.twoWheeler || 0) + 1)}
//           error={errors.twoWheeler}
//         />
//         <CounterField
//           label="Four-Wheeler Parking"
//           value={form.fourWheeler || 0}
//           onDecrement={() => updateFieldValue("fourWheeler", Math.max(0, Number(form.fourWheeler || 0) - 1))}
//           onIncrement={() => updateFieldValue("fourWheeler", Number(form.fourWheeler || 0) + 1)}
//           error={errors.fourWheeler}
//         />
//       </div>
//     </div>
//   );
