...
//     if (docs.some(d => d.status === "pending")) return { label: "Pending Review", color: "text-amber-600 bg-amber-50", icon: Clock };
...
//     <div
//       onClick={() => {
//         navigate(`/property/residential/${property?._id}`);
//       }}
...
export default function ResidentialCard({ property }) {
  ...
  return (
    <div
      onClick={() => navigate(`/property/residential/${property?._id}`)}
        ...
        <div className="flex-1 min-w-0 p-2.5 flex flex-col justify-between">
          ...
          <div className="flex items-center gap-2 text-[9px] text-slate-600 mb-1.5">
            <span className="flex items-center gap-0.5">
              <Bed className="w-2.5 h-2.5 text-slate-400" />
            ...
            <span className="flex items-center gap-0.5">
              <Bath className="w-2.5 h-2.5 text-slate-400" />
              <span className="font-semibold">
