...
const PropertyVerification = () => {
  ...
  const mutation = useMutation({
    mutationFn: (payload) => updateAgriculturalDocumentStatus(id, payload),
    onSuccess: () => {
      queryClient.invalidateQueries(["agricultural", id]);
      ...
      if (currentIndex < docs.length - 1) {
        ...
        setTimeout(() => navigate("/agricultural"), 1500);
      }
    },
  ...
  if (isLoading)
    ...
    const REJECTION_REASONS = [
        ...
        "Agricultural land details do not match the uploaded document",
        "Land images are unclear or of poor quality",
