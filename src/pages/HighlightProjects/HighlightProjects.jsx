...
export default function HighlightProjects() {
  ...
  const visibleProperties = useMemo(() => {
    if (!selectedLocation) return sortedProperties;
    return sortedProperties.filter((p) => p.city?.trim() === selectedLocation);
  }, [sortedProperties, selectedLocation]);

  /* ---------------- DRAG HANDLER (locations only) ---------------- */
  ...
  // Called by card after a rank PATCH succeeds — refetch & re-sort
  ...
  const stats = [
    {
      label: "Create Top Selling Projects",
      icon: Plus,
      value: "",
    ...
    {
      label: "Active Top Selling Projects",
      icon: Building2,
    ...
    {
      label: "Inactive Top Selling Projects",
      icon: Building2,
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white w-full max-w-md p-6 rounded-xl shadow-xl">
            ...
            <p className="text-slate-700 mt-2">
              Are you sure you want to delete this Top Selling Project?
            </p>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 mt-1">
            Explore premium Top Selling listings.
          </p>
        ...
        <div className="p-6 flex flex-col text-center">
          ...
          <p className="text-slate-500 text-sm">Total Top Selling Projects</p>
        </div>
      </div>
        ...
        {stats.map((stat, index) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                stat.route &&
                navigate(stat.route, { state: { type: "highlight" } })
              }
            ...
            <div className="absolute z-50 left-0 mt-3 w-full bg-white border shadow-xl rounded-xl p-3 max-h-64 overflow-hidden">
              {locations.length === 0 ? (
                ...
                <DragDropContext onDragEnd={handleDragEnd}>
                  <Droppable droppableId="highlightLocations">
                    {(provided) => (
                      <div
      ...
      <div className="mt-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-bold text-[#27AE60]">
            Top Selling Projects
          </h2>
