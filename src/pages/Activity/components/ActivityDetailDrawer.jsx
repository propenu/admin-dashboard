        ...
        <div className="flex items-start justify-between gap-3 border-b border-[#e7f2eb] px-5 py-4">
          <div className="flex min-w-0 items-center gap-3">
            {activity.userAvatar ? (
              ...
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#EAF8F0] text-xs font-bold text-[#27AE60]">
            ...
            <div className="min-w-0">
              <h3
                ...
                className="truncate text-base font-bold text-[#0f3d2e]"
              >
                {activity.userName}
              </h3>
              ...
              <p className="mt-0.5 text-[11px] font-semibold text-[#27AE60]">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-lg p-2 text-slate-500 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-[#27AE60]/30"
            aria-label="Close"
          >
            <X className="h-4 w-4" />
          </button>
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-5 py-4">
          <section className="grid grid-cols-2 gap-3 text-xs">
            {activity.email ? (
              <div className="rounded-xl border border-slate-100 bg-white p-3">
                ...
                <p className="mt-1 break-all font-medium text-[#0f3d2e]">{activity.email}</p>
              </div>
            ) : null}
            {activity.phone ? (
              <div className="rounded-xl border border-slate-100 bg-white p-3">
                ...
                <p className="mt-1 font-medium text-[#0f3d2e]">{activity.phone}</p>
              </div>
            ) : null}
            <div className="rounded-xl border border-slate-100 bg-white p-3">
              <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
              ...
              <p className="mt-1 font-medium text-[#0f3d2e]">{activity.whenLabel}</p>
            </div>
            <div className="rounded-xl border border-slate-100 bg-white p-3">
              <p className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
                Latest outcome
          ...
          <section>
            <div className="mb-2 flex items-center justify-between gap-2">
              ...
              {loadingTimeline ? (
                <Loader2 className="h-3.5 w-3.5 animate-spin text-[#27AE60]" />
              ) : (
              ...
              {timeline.map((row, index) => (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <p className="text-[13px] font-semibold leading-snug text-[#0f3d2e]">
                      {row.what}
                    </p>
            ...
            {page < totalPages ? (
              <button
                ...
                className="mt-3 inline-flex w-full items-center justify-center gap-1 rounded-xl border border-[#d9ebe0] bg-white px-3 py-2.5 text-xs font-semibold text-[#27AE60] hover:bg-[#EAF8F0] disabled:opacity-50"
              >
                {loadingMore ? (
