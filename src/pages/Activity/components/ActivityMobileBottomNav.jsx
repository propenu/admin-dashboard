...
const TABS = [
  ...
  { id: "attention", label: "Focus", icon: AlertTriangle },
  { id: "top", label: "Top", icon: UserRound },
];

/**
 * RN-style animated bottom tabs for All Users Activity (mobile only).
 */
export default function ActivityMobileBottomNav({
  activeTab,
  onTabChange,
  badges = {},
}) {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-lg px-3 pb-2 pt-1 sm:max-w-2xl">
        <div
          ref={trackRef}
          className="relative flex items-stretch gap-0.5 rounded-[22px] border border-emerald-100/80 bg-white/95 p-1.5 shadow-[0_-4px_24px_rgba(15,23,42,0.12),0_8px_24px_rgba(39,174,96,0.14)] backdrop-blur-xl"
        >
          <span
            aria-hidden
