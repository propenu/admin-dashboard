...
/**
 * Permission gate — reuses shared /me cache.
 * No second green LoadingSpinner (Suspense already covered chunk load).
 */
export default function PermissionRoute({
  ...
  const { user, permissions, roleName, isPending, isError } = useAuthUserProfile();
