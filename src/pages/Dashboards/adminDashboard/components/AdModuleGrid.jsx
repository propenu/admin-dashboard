...
export default function AdModuleGrid({ modules = [], onOpen }) {
  return (
    <article className="overflow-hidden rounded-[14px] border border-slate-200 bg-white shadow-sm">
      <header className="border-b border-slate-100 px-3.5 py-2.5">
        <h3 className="text-xs font-bold text-slate-900">Admin desks</h3>
        <p className="text-[10px] text-slate-500">Jump straight into the queue that needs you</p>
      </header>
