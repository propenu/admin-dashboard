...
//   const states = payload?.country
//     ? State.getStatesOfCountry(payload.country)
//     : [];

//   const cities =
//     payload?.country && payload?.stateCode
//       ? City.getCitiesOfState(payload.country, payload.stateCode)
//       : [];
...
//               });
//             }}
//             className="w-full border-2 border-gray-200 rounded-xl p-3 text-sm outline-none"
//           >
