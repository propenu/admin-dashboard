...
export default function SignUp() {
  ...
  // Logic: Request OTP — sends name, email, role to service
  ...
  // Logic: Auto-Verify when last OTP box is filled — sends otp, email, name, role
  useEffect(() => {
            ...
            {step === 1 ? (
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full pl-11 pr-10 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-green-500/10 focus:border-green-500 outline-none transition-all font-medium text-slate-700 appearance-none cursor-pointer"
                    >
                      {ROLES.map((r) => (
                ...
                <button
                  ...
                  disabled={
                    loading || !name.trim() || !isValidEmail(email) || !role
                  }
